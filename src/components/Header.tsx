  ...
  return (
    <header className="flex items-center py-2 px-2 sm:px-0 sm:py-3 space-x-2 opacity-50 hover:opacity-100 transition-all duration-300">
      <div className="flex space-x-2">
        <Link href="/">
          <a
            className="flex shrink-0 w-9 sm:w-10 rounded-2xl text-violet-100/20 hover:text-violet-400 bg-violet-100/0 hover:bg-violet-100/10 cursor-pointer transition-all duration-300"
            tabIndex={-1}
          >
